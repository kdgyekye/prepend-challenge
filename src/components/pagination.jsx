...
import {addpageToRoute} from "../utils/addPageToRoute";


const Pagination = ({ total, limit, setSkip, skip }) => {
			...
			>
				...
				<div className="flex-1 flex justify-between sm:justify-end">
					<button
						...
						disabled={skip === 0}
						className={`inline-flex items-center w-24 px-3 py-3 border text-sm leading-4 font-medium rounded-none text-gray-700 ${
							skip > 0
								? "bg-white text-gray-600 hover:text-gray-400 focus:outline-none focus:border-yellow-700"
								: "bg-gray-100 text-gray-400 cursor-not-allowed focus:outline-none border-transparent "
						}  focus:shadow-outline-blue active:bg-blue-600 transition ease-in-out duration-150`}
					...
					<button
						...
						className={`inline-flex items-center ml-3 w-24 justify-center py-3 border text-sm leading-4 font-medium rounded-none text-gray-700 ${
							skip + limit < total
								? "bg-yellow-400 text-gray-800 hover:text-gray-800 hover:bg-yellow-500 focus:outline-none focus:border-blue-500"
								: "bg-gray-100 text-gray-400 cursor-not-allowed focus:outline-none border-transparent "
						}  focus:shadow-outline-blued active:bg-blue-600 transition ease-in-out duration-150`}
